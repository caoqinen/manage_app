      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="12">
        <el-card shadow="hover">
          ...
          <div class="schart-box">
            ...
            ></i>
            <schart class="schart" v-else canvasId="bar" :options="options1" style="width: 600px;"></schart>
          </div>
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="24" :md="24" :lg="12">
...
export default {
  ...
  async mounted() {
    ...
    if (!localStorage.getItem("InvitationData")) {
      ...
      localStorage.setItem("InvitationData", JSON.stringify(arr));
    }
    this.options2.datasets[1].data = JSON.parse(
      localStorage.getItem("InvitationData")
    );

    if (!localStorage.getItem("left_data")) {
      ...
      localStorage.setItem("left_data", JSON.stringify(ind));
    }

    JSON.parse(localStorage.getItem("left_data")).forEach((item) => {
    ...
    this.options2.datasets[0].data = JSON.parse(localStorage.getItem("arr"));
    this.options2.labels = JSON.parse(localStorage.getItem("date"));
    this.options1.labels = JSON.parse(localStorage.getItem("date"));
